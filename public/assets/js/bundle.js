...
var Item = React.createClass({ displayName: "Item",
    render: function render() {
        return React.createElement("div", { className: "result__item" }, React.createElement("a", { href: this.props.item.url }, React.createElement("div", null, React.createElement("img", { src: this.props.item.imageUrl })), React.createElement("p", null, this.props.item.name), React.createElement("ul", { className: "list01" }, React.createElement("li", { className: "list01__item" }, "author: ", this.props.item.author))));
    }
});
